    ...
    switch (favourite.type) {
      ...
      case 'FORECAST':
        ...
        if (groupType === 'UTILITY') {
          ...
          var [g] = population.fromString(favourite.queries[0].population[0].label);
          if (!g.clusterKey) {
      ...
      switch (this.props.selectedFavourite.type) {
        ...
        case 'FORECAST':
          ...
          if (groupType === 'UTILITY') {
            ...
            var [g] = population.fromString(this.props.selectedFavourite.queries[0].population[0].label);
            if (!g.clusterKey) {
...
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators(Object.assign({}, {
      setTimezone, fetchFavouriteQueries,
      ...
      pinToDashboard, unpin, getMetersLocations
    }), dispatch)
  };
}
